...
%\usepackage{txfonts}
\usepackage{mathptmx} %Applies for Math and Times font
\usepackage{setspace}
\renewcommand{\baselinestretch}{1.0} 
\usepackage{amsmath} %cannot be used with txfonts
\usepackage{multicol} 
...
\newcommand\mb[1]{\begin{bmatrixcolor}[white]#1\end{bmatrixcolor}}
\newcommand\dtm[1]{\left|\begin{bmatrixcolor}[white]#1\end{bmatrixcolor}\right|}
\newcommand\case[1]{\begin{cases}#1\end{cases}}
\newcommand\ctt[1]{\textcircled{\tiny #1}}
...
\renewcommand{\aa}[1]{\begin{align*}#1\end{align*}}
